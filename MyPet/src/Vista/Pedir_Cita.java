...
public class Pedir_Cita extends javax.swing.JFrame {

    ArrayList<String> lstArticulo = new ArrayList<>();
    int cod = -1,IdUsuario;
    public Pedir_Cita() {
        initComponents();
        this.setSize(416, 410);
    ...
    private void initComponents() {
        ...
        btnSaveAA.setBounds(190, 250, 110, 40);
        ...
        lblTittleEA.setText("Pedir Cita");
        ...
        btnCancelarAA.setBounds(50, 250, 110, 40);
        ...
        lblCodProv2.setBounds(30, 180, 250, 25);

        pnlEditarArticulo.add(cmbMascotas);
        cmbMascotas.setBounds(30, 210, 300, 26);

        pnlBackgroundEA.add(pnlEditarArticulo);
        pnlEditarArticulo.setBounds(20, 20, 360, 330);

        getContentPane().add(pnlBackgroundEA);
        pnlBackgroundEA.setBounds(0, 0, 400, 380);
    ...
    private void btnSaveAAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveAAActionPerformed
        if(Modelo.CitasAccess.comprobarCita(getNewDate()) == -1){
            ...
            pet = pet.substring(0,pet.indexOf('-'));
            int filas = Modelo.CitasAccess.agregarCita(getNewDate(),Integer.parseInt(pet), 11, 1);
            if (filas != 0){
                ...
                JOptionPane.showMessageDialog(null,"La cita no se pudo actualizar.","Error",JOptionPane.ERROR_MESSAGE);
        }else
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pedir_Cita.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pedir_Cita().setVisible(true);
            }
        });
    }
