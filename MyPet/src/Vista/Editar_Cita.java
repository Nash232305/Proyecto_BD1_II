...
public class Editar_Cita extends javax.swing.JFrame {
    ...
    private void llenarCampos(){
        if (!lstArticulo.isEmpty()){
            ...
            cmbEstado.setSelectedIndex(Integer.parseInt(lstArticulo.get(1))-1);
        }
    }
    ...
    private void initComponents() {
        ...
        lblTittleEA.setText("Editar Cita");
    ...
    private void btnSaveAAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveAAActionPerformed
        if(Modelo.CitasAccess.getCita(getNewDate(),cod) == -1){
            if (cod!=-1) { 
                ...
                System.out.println("petttttt:" + pet);
                System.out.println("docccccc:" + doc);
                int filas = Modelo.CitasAccess.editarCita(cod, Integer.parseInt(pet) ,getNewDate(),  Integer.parseInt(doc), cmbEstado.getSelectedIndex()+1);
                if (filas != 0){
                ...
                JOptionPane.showMessageDialog(null,"Error, cita no encontrada","Error",JOptionPane.ERROR_MESSAGE);
        }else
